...
class FlightInfo:
    ...
    屬性:
        ...
        routeSearchToken (Optional[str]): 搜尋ID
        outboundToken (Optional[str]): 去程ID
        product_desc (bool): 是否為海外供應商
    """
    ...
    routeSearchToken: Optional[str] = None
    outboundToken: Optional[str] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "routeSearchToken": self.routeSearchToken,
            "outboundToken": self.outboundToken,
